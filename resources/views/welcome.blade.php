<x-guest-layout>
   ...
   <section
    ...
    style="background-image: url('assets/leaflet/images/company.png')"
>
    <!-- Overlay -->
...
<section class="w-full bg-white py-24">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <!-- Card 1 -->
            <div class="bg-white rounded-xl px-8 py-10 text-center shadow-sm hover:shadow-md transition">
                <span class="inline-block mb-4 px-4 py-1 text-sm font-semibold text-green-700 bg-green-100 rounded-full">
                    Otomatis
                </span>
    ...
    <section class="w-full bg-white py-24">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl font-bold text-gray-900 mb-2">Tahapan Penggunaan</h2>
            <div class="h-1 w-20 bg-green-700 mb-20"></div>

            <div class="flex items-center justify-center gap-8">

                <!-- STEP 1 -->
                <div class="flex flex-col items-center">
                    <div class="w-24 h-24 bg-orange-300 rounded-3xl flex items-center justify-center shadow-lg mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Registrasi</h3>
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                    <span class="w-2.5 h-2.5 bg-orange-300 rounded-full"></span>
                    <div class="w-24 border-t-2 border-dashed border-gray-300"></div>
                    <span class="w-2.5 h-2.5 bg-green-500 rounded-full"></span>
                </div>

                <!-- STEP 2 -->
                <div class="flex flex-col items-center">
                    <div class="w-24 h-24 bg-green-500 rounded-3xl flex items-center justify-center shadow-lg mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Verifikasi</h3>
                    <p class="text-gray-600 text-center max-w-xs">
                ...
                <!-- STEP 3 -->
                <div class="flex flex-col items-center">
                    <div class="w-24 h-24 bg-blue-400 rounded-3xl flex items-center justify-center shadow-lg mb-6">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Absensi Rutin</h3>
                    <p class="text-gray-600 text-center max-w-xs">
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    ...
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola administrasi dan aspek hukum perusahaan.</p>
                    <p class="text-xs text-gray-600 mb-4">6 tugas • 8 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-green-100 text-green-700 text-sm font-semibold rounded-full hover:bg-green-200">Lihat Detail →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    ...
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola perencanaan dan pengembangan karyawan.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 8 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full hover:bg-blue-200">Lihat Detail →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    <div class="flex justify-center mb-6">
                        <div class="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center shadow-lg">
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M17.92 7.02C17.45 4.18 14.97 2 12 2c-2.97 0-5.45 2.18-5.92 5.02C5.97 7.42 4.25 9.22 4.25 11.5c0 2.78 2.22 5 5 5h.93v-1.93H9c-1.71 0-3.07-1.36-3.07-3.07 0-1.5 1.08-2.76 2.51-2.99.4-.23.75-.62 1.01-1.1.26-.48.6-.98 1.04-1.37.44-.38.98-.66 1.56-.83.58-.17 1.19-.23 1.75-.11.56.12 1.08.37 1.54.76.46.39.82.88 1.07 1.42.25.54.4 1.12.44 1.71.04.59-.04 1.18-.2 1.74s-.5 1.08-.91 1.52h-.93V18.5h.93c2.78 0 5-2.22 5-5 0-2.28-1.72-4.08-3.88-4.48z"></path>
                            </svg>
                        </div>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2">Tanaman dan Teknik Pengolahan</h3>
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola operasional, budidaya dan pengolahan hasil perkebunan.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 8 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-green-100 text-green-700 text-sm font-semibold rounded-full hover:bg-green-200">Lihat Detail →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    ...
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola keuangan dan pelaporan perusahaan.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 10 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-yellow-100 text-yellow-700 text-sm font-semibold rounded-full hover:bg-yellow-200">Lihat Detail →</a>
                </div>
                    ...
                    <div class="flex justify-center mb-6">
                        <div class="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center shadow-lg">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path d="M21 16V8c0-.5-.37-.93-.88-1L12 3.44 3.88 7C3.37 7.07 3 7.5 3 8v8c0 .5.37.93.88 1l8.12 3.56 8.12-3.56c.51-.07.88-.5.88-1zm-9 1.15l-6-2.6v-5.02l6-2.6 6 2.6v5.02l-6 2.6z"></path>
                            </svg>
                        </div>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2">Manajemen Aset dan Pemasaran</h3>
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola aset serta pemasaran produk perusahaan.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 8 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-orange-100 text-orange-700 text-sm font-semibold rounded-full hover:bg-orange-200">Lihat Detail →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    <div class="flex justify-center mb-6">
                        <div class="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg">
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7zm0-12c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z"></path>
                            </svg>
                        </div>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2">Kepatuhan dan Manajemen Risiko</h3>
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertu apana untuk kepatuhan dan risiko dari praktik manajemen.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 8 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-yellow-100 text-yellow-700 text-sm font-semibold rounded-full hover:bg-yellow-200">Lihat Detail →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition p-6 text-center">
                    <div class="flex justify-center mb-6">
                        <div class="w-16 h-16 bg-blue-400 rounded-full flex items-center justify-center shadow-lg">
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 9h4v2h-4v-2zm0 4h4v2h-4v-2zM7 7h10v2H7z"></path>
                            </svg>
                        </div>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2">Project Management Office (PMO)</h3>
                    <p class="text-xs text-gray-500 mb-3">Kepala: biablablabla, S.Kom., M.M</p>
                    <p class="text-sm text-gray-700 mb-4">Bertanggung jawab dalam mengelola dan mengkoordinasikan pelaksanaan proyek.</p>
                    <p class="text-xs text-gray-600 mb-4">9 tugas • 10 kegiatan magang</p>
                    <a href="#" class="inline-block px-4 py-2 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full hover:bg-blue-200">Lihat Detail →</a>
                </div>
            </div>
